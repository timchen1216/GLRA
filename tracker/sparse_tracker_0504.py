...
class SparseTracker(object):
    ...
    def update(self, output_results, curr_img=None):
        ...
        if self.use_glra and len(u_strack) > 0 and len(u_detection_sec) > 0:
            glra_dists = glra_distance(
                u_strack,
                u_detection_sec,
                self.frame_id,
